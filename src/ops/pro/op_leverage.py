"""Operating leverage notes

Version theme: v5.30.0 maturity train.
...
TITLE = "Op Leverage"
VERSION_THEME = "v5.30.0"
DESCRIPTION = """Operating leverage notes"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "op_leverage.jsonl"
_STATE = "op_leverage_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "op_leverage"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "op_leverage"})
