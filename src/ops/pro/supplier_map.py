...
Version theme: v5.18.0 maturity train.
...
TITLE = "Supplier Map"
VERSION_THEME = "v5.18.0"
DESCRIPTION = """Supplier concentration map"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "supplier_map.jsonl"
_STATE = "supplier_map_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "supplier_map"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "supplier_map"})
