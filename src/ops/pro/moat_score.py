"""Moat scorecard (process)

Version theme: v5.22.0 maturity train.
...
TITLE = "Moat Score"
VERSION_THEME = "v5.22.0"
DESCRIPTION = """Moat scorecard (process)"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "moat_score.jsonl"
_STATE = "moat_score_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "moat_score"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "moat_score"})
