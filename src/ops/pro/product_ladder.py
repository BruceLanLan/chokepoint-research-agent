"""Product ladder / SKU map

Version theme: v5.46.0 maturity train.
...
VERSION_THEME = "v5.46.0"
DESCRIPTION = """Product ladder / SKU map"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "product_ladder.jsonl"
_STATE = "product_ladder_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "product_ladder"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "product_ladder"})
