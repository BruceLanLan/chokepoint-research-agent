"""ESG process checklist (non-advice)

Version theme: v5.38.0 maturity train.
...
TITLE = "Esg Process"
VERSION_THEME = "v5.38.0"
DESCRIPTION = """ESG process checklist (non-advice)"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "esg_process.jsonl"
_STATE = "esg_process_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "esg_process"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "esg_process"})
