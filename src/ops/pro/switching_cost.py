...
Version theme: v5.48.0 maturity train.
...
VERSION_THEME = "v5.48.0"
DESCRIPTION = """Switching cost evidence"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "switching_cost.jsonl"
_STATE = "switching_cost_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "switching_cost"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "switching_cost"})
