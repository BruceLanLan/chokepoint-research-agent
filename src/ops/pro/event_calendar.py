"""Research event calendar store

Version theme: v5.2.0 maturity train.
...
VERSION_THEME = "v5.2.0"
DESCRIPTION = """Research event calendar store"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "event_calendar.jsonl"
_STATE = "event_calendar_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "event_calendar"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "event_calendar"})
