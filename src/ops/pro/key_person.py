...
Version theme: v5.44.0 maturity train.
...
TITLE = "Key Person"
VERSION_THEME = "v5.44.0"
DESCRIPTION = """Key-person risk notes"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "key_person.jsonl"
_STATE = "key_person_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "key_person"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "key_person"})
