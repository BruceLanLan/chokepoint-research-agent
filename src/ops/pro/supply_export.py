"""Supply-chain graph JSON export

Version theme: v5.10.0 maturity train.
...
TITLE = "Supply Export"
VERSION_THEME = "v5.10.0"
DESCRIPTION = """Supply-chain graph JSON export"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "supply_export.jsonl"
_STATE = "supply_export_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "supply_export"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "supply_export"})
