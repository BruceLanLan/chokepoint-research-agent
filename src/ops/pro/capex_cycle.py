...
Version theme: v5.25.0 maturity train.
...
TITLE = "Capex Cycle"
VERSION_THEME = "v5.25.0"
DESCRIPTION = """Capex cycle tracker"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "capex_cycle.jsonl"
_STATE = "capex_cycle_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "capex_cycle"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "capex_cycle"})
