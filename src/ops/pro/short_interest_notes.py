"""Short interest context notes

Version theme: v5.33.0 maturity train.
...
TITLE = "Short Interest Notes"
VERSION_THEME = "v5.33.0"
DESCRIPTION = """Short interest context notes"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "short_interest_notes.jsonl"
_STATE = "short_interest_notes_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "short_interest_notes"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "short_interest_notes"})
