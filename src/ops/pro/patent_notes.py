...
Version theme: v5.20.0 maturity train.
...
TITLE = "Patent Notes"
VERSION_THEME = "v5.20.0"
DESCRIPTION = """Patent landscape notes"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "patent_notes.jsonl"
_STATE = "patent_notes_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "patent_notes"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "patent_notes"})
