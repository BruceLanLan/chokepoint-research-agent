"""Peer set builder for compare mode

Version theme: v5.11.0 maturity train.
...
TITLE = "Peer Set"
VERSION_THEME = "v5.11.0"
DESCRIPTION = """Peer set builder for compare mode"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "peer_set.jsonl"
_STATE = "peer_set_state.json"
...
def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "peer_set"})
