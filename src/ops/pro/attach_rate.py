"""Attach rate / pull-through notes

Version theme: v5.47.0 maturity train.
...
TITLE = "Attach Rate"
VERSION_THEME = "v5.47.0"
DESCRIPTION = """Attach rate / pull-through notes"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "attach_rate.jsonl"
_STATE = "attach_rate_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "attach_rate"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "attach_rate"})
