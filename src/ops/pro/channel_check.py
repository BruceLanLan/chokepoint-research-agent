"""Channel check interview prompts

Version theme: v5.13.0 maturity train.
...
TITLE = "Channel Check"
VERSION_THEME = "v5.13.0"
DESCRIPTION = """Channel check interview prompts"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "channel_check.jsonl"
_STATE = "channel_check_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "channel_check"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "channel_check"})
