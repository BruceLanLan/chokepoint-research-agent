...
Version theme: v5.24.0 maturity train.
...
TITLE = "Cash Cycle"
VERSION_THEME = "v5.24.0"
DESCRIPTION = """Cash conversion notes"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "cash_cycle.jsonl"
_STATE = "cash_cycle_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "cash_cycle"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "cash_cycle"})
