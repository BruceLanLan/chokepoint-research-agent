"""Insider/filing narrative notes

Version theme: v5.32.0 maturity train.
...
TITLE = "Insider Notes"
VERSION_THEME = "v5.32.0"
DESCRIPTION = """Insider/filing narrative notes"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "insider_notes.jsonl"
_STATE = "insider_notes_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "insider_notes"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "insider_notes"})
