...
Version theme: v5.40.0 maturity train.
...
TITLE = "Related Party"
VERSION_THEME = "v5.40.0"
DESCRIPTION = """Related-party transaction notes"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "related_party.jsonl"
_STATE = "related_party_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "related_party"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "related_party"})
