...
Version theme: v5.28.0 maturity train.
...
TITLE = "Asp Tracker"
VERSION_THEME = "v5.28.0"
DESCRIPTION = """ASP / mix tracker"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "asp_tracker.jsonl"
_STATE = "asp_tracker_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "asp_tracker"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "asp_tracker"})
