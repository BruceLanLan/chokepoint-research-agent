...
Version theme: v5.35.0 maturity train.
...
TITLE = "Macro Link"
VERSION_THEME = "v5.35.0"
DESCRIPTION = """Macro linkage notes"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "macro_link.jsonl"
_STATE = "macro_link_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "macro_link"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "macro_link"})
