"""Commodity input linkage

Version theme: v5.37.0 maturity train.
...
VERSION_THEME = "v5.37.0"
DESCRIPTION = """Commodity input linkage"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "commodity_link.jsonl"
_STATE = "commodity_link_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "commodity_link"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "commodity_link"})
