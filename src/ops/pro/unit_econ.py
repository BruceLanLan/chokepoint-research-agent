...
Version theme: v5.23.0 maturity train.
...
TITLE = "Unit Econ"
VERSION_THEME = "v5.23.0"
DESCRIPTION = """Unit economics worksheet"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "unit_econ.jsonl"
_STATE = "unit_econ_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "unit_econ"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "unit_econ"})
