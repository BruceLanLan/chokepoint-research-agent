...
Version theme: v5.16.0 maturity train.
...
TITLE = "Geo Risk"
VERSION_THEME = "v5.16.0"
DESCRIPTION = """Geographic concentration risk"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "geo_risk.jsonl"
_STATE = "geo_risk_state.json"
...
def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "geo_risk"})
