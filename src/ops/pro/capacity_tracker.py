...
Version theme: v5.14.0 maturity train.
...
VERSION_THEME = "v5.14.0"
DESCRIPTION = """Capacity / utilization notes"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "capacity_tracker.jsonl"
_STATE = "capacity_tracker_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "capacity_tracker"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "capacity_tracker"})
