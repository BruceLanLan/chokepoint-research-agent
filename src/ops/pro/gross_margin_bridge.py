"""GM bridge research notes

Version theme: v5.29.0 maturity train.
...
VERSION_THEME = "v5.29.0"
DESCRIPTION = """GM bridge research notes"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "gross_margin_bridge.jsonl"
_STATE = "gross_margin_bridge_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "gross_margin_bridge"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "gross_margin_bridge"})
