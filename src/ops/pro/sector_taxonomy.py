"""Sector/theme taxonomy tree

Version theme: v5.5.0 maturity train.
...
VERSION_THEME = "v5.5.0"
DESCRIPTION = """Sector/theme taxonomy tree"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "sector_taxonomy.jsonl"
_STATE = "sector_taxonomy_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "sector_taxonomy"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "sector_taxonomy"})
