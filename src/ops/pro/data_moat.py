"""Data moat evidence log

Version theme: v5.50.0 maturity train.
...
TITLE = "Data Moat"
VERSION_THEME = "v5.50.0"
DESCRIPTION = """Data moat evidence log"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "data_moat.jsonl"
_STATE = "data_moat_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "data_moat"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "data_moat"})
