...
Version theme: v5.17.0 maturity train.
...
TITLE = "Customer Map"
VERSION_THEME = "v5.17.0"
DESCRIPTION = """Customer concentration map"""
DISCLAIMER = "research_only_not_investment_advice"
_STORE = "customer_map.jsonl"
_STATE = "customer_map_state.json"
...
def set_state(**fields: Any) -> dict[str, Any]:
    ...
    cur["module"] = "customer_map"
    write_json(_STATE, cur)
    return cur


def get_state() -> dict[str, Any]:
    return read_json(_STATE, {"version": 1, "fields": {}, "module": "customer_map"})
