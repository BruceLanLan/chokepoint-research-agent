...
> **Homepage is Chinese-first:** see **[README.md](README.md)** for the primary project intro and screenshots.
...
| | |
|---|---|
| **Version** | **10.0.1** (docs freeze) |
| **Language** | Python ≥ 3.11 |
| **License** | MIT |
| **中文（主 README）** | [README.md](README.md) · [docs/zh/](docs/zh/README.md) |
